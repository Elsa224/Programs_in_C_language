...
#include <stdlib.h>
#include <string.h>
#define TAILLE_N 4 //N = 10 mais pour la mise au point des programmes, utiliser tab[6] ou tab[7]
...
void creationFICH_BASE(FILE *pointeurFichier, etudiant tableau[])
{
    ...
    pointeurFichier = fopen("FICH_FINAL", "w");
    creationFichier(pointeurFichier, tableau);

    //lecture du fichier FICH_BASE
    pointeurFichier = fopen("FICH_FINAL.txt", "r");
    lectureFichier(pointeurFichier, tableau);
